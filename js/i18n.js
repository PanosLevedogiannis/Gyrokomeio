...
window.I18N = {
  en: {
    ...
    'game.title': 'Fill the pita',
    'game.lede': 'Catch gyros, tomato, onion, tzatziki and fries. Get all five for a pita «με όλα». Let the pineapple drop.',
    'game.canvasLabel': 'Game: move the pita and catch the ingredients',
    'game.score': 'Score',
    'game.pitas': 'Pitas',
    'game.time': 'Time',
    'game.play': 'Play',
    'game.how': 'Move the pita with your mouse, your finger or the arrow keys.',
    'game.paused': 'Paused',
    'game.resume': 'Resume',
    'game.overTitle': 'Time’s up!',
    'game.again': 'Play again',
    'game.order': 'Hungry? Order',
    'game.share': 'Challenge a friend',
  ...
  js: {
    ...
    'game.result': { el: 'Έφτιαξες {pitas} {word} «με όλα» και έκανες {score} πόντους.', en: 'You made {pitas} {word} «με όλα» and scored {score}.' },
    'game.pita1': { el: 'πίτα', en: 'pita' },
    'game.pitaN': { el: 'πίτες', en: 'pitas' },
    'game.best': { el: 'Ρεκόρ σου: {best}', en: 'Your best: {best}' },
    'game.newBest': { el: 'Νέο ρεκόρ!', en: 'New best!' },
    'game.full': { el: 'Με όλα!', en: 'Με όλα!' },
    'game.pineapple': { el: 'Ανανάς; Όχι!', en: 'Pineapple? No!' },
    'game.loading': { el: 'Φόρτωση…', en: 'Loading…' },
    'game.copied': { el: 'Το link αντιγράφηκε', en: 'Link copied' },
    'game.shareText': { el: 'Έκανα {score} πόντους στο «Γέμισε την πίτα» του Γυροκομείου. Μπορείς καλύτερα;', en: 'I scored {score} in Gyrokomeio’s «Fill the pita». Can you beat it?' },
